...
class Application {
    ...
    constructor(applicationName = 'default', applicationIcon = 'def.svg', width = 400, height = 400, left = 0, top = 0) {
    ...
    #setStyle() {
        ...
        this.#application.style.marginLeft = '2px';
        this.#application.style.overflow = 'hidden';
        this.#application.style.position = 'fixed';
        this.#application.style.zIndex = 1;
        this.#application.style.left = this.#left + 'px';;
        this.#application.style.top = this.#top + 'px';
        this.#application.style.backgroundColor = 'rgb(255, 255, 255)';
        this.#applicationHeader.style.position = 'sticky';
        this.#applicationHeader.style.top = 0;
        this.#applicationHeader.style.width = '100%';
        this.#applicationHeader.style.height = 'auto';
        this.#applicationHeader.style.backgroundColor = 'rgb(0, 149, 189)';
        this.#applicationWorkSpace.style.width = '100%';
        this.#applicationWorkSpace.style.overflow = 'auto';
    }
    ...
    #eventConstruct() {
		...
		function selected() {
			...
			app.style.boxShadow = '1px 1px 3px black';
			app.classList.add('selected');
		}

        function mutationController(manager, guided) {
        ...
        this.#applicationEvents.set('mutationController', mutationController);
    }
    ...
    #createApplicationHeadline() {
        ...
        headline.style.fontFamily = 'courier new';
    ...
    #setContextToolBarEvents() {
		this.#applicationContextToolBar.addLabel(new ContextToolBarLabel('close', 'def.svg', this.#applicationEvents.get('close')));
		this.#applicationContextToolBar.addLabel(new ContextToolBarLabel('expand', 'def.svg', this.#applicationEvents.get('expand')));
		this.#applicationContextToolBar.addLabel(new ContextToolBarLabel('roll', 'def.svg', this.#applicationEvents.get('roll')));
    }
    ...
    #setEventListeners() {
        ...
        let workSpaceHeightController = this.#applicationEvents.get('mutationController');
        workSpaceHeightController(this.#application, this.#applicationWorkSpace);
    }
